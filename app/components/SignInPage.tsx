...
const SignInPage: React.FC<SignInPageProps> = ({ onPageChange }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Call the Node.js API login endpoint
      ...
      if (!response.ok) {
        // Handle API errors
        setGeneralError(data.error || 'An error occurred during login');
        return;
      }
      ...
      console.log('🔍 Token verification - saved correctly:', savedToken ? 'YES' : 'NO');
        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <p className="animate-element animate-delay-200 text-muted-foreground">
              Sign in to continue managing your inventory with AI-powered insights
            </p>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="animate-element animate-delay-600 flex justify-end">
                <button
                  type="button"
            ...
            <p className="animate-element animate-delay-1000 text-center text-sm text-muted-foreground">
              Don't have an account? <button onClick={() => router.push('/signup')} className="text-violet-400 hover:underline transition-colors">Sign Up</button>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="hidden md:block flex-1 relative p-4">
        <div className="animate-slide-right animate-delay-300 absolute inset-4 rounded-3xl bg-gradient-to-br from-violet-500/20 to-blue-500/20 backdrop-blur-sm border border-white/10 flex items-center justify-center">
          <div className="text-center p-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">Welcome Back to StorageX</h2>
            <p className="text-muted-foreground mb-6">Access your AI-powered inventory management dashboard</p>
